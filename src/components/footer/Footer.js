    ...
    <footer>
      <div className="container">
        <FooterDiv>
          ...
          <InfoDiv>
            <InfoTitle>인디프 | 변리사 매칭은, 인디프</InfoTitle>
            <InfoDetail>원하는 변리사를 직접 만나보세요</InfoDetail>
          </InfoDiv>

          <InfoDiv>
            <InfoTitle>(주) 인디프</InfoTitle>
            ...
            <InfoDetail>
              ...
              (주)인디프는 어떠한 법적 책임을 지지 않습니다. 본 웹사이트에서 취득한 정보를 바탕으로 하여 어떠한 조치를
              취하시기에 앞서 반드시 법률전문가와 충분한 상담을 진행하시기 바랍니다.
              <br />
              (주)인디프는 공정한 수임질서를 지키기 위해 노력하며 변리사법 및 기타 관련 규정을 준수하고 있습니다. 모든
              특허상담은 인디프에 가입한 변리사 회원이 직접 진행합니다. 인디프에 표시된 변리사 회원의 정보는 해당 변리사
              회원이 직접 제공한 것이며, 모든 변리사 회원은 독립적으로 업무를 수행합니다.
            </InfoDetail>
          </InfoDiv>
